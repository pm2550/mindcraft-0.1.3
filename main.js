...
const startAgents = async () => {
    const delayMs = settings.agent_start_delay_ms ?? 0;
    const maxBots = settings.max_active_bots ?? 0;
    const profiles = maxBots > 0 ? settings.profiles.slice(0, maxBots) : settings.profiles;
